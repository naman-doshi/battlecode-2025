package caterpillow_cur.robot.agents.soldier;
...
import static caterpillow_cur.Game.*;
import static caterpillow_cur.tracking.CellTracker.*;
import static caterpillow_cur.tracking.TowerTracker.*;
