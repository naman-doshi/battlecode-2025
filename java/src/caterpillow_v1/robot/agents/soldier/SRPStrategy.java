...
import static caterpillow_v1.Config.canUpgrade;
...
import caterpillow_v1.robot.agents.roaming.ExplorationRoamStrategy;
import caterpillow_v1.util.Pair;
import caterpillow_v1.util.Profiler;
...
public class SRPStrategy extends Strategy {
    ...
    public void runTick() throws GameActionException {
        ...
        if (target != null) {
            if (rc.getLocation().distanceSquaredTo(target.getMapLocation()) <= 9) {
                ...
                updateStates();
                if (rc.isActionReady()) {
                    MapInfo target2 = getNearestCell(this::isPossibleTarget, 9);
